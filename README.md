...
Generating patterns made by particles on a vibrating plate, also known as Chladni patterns, using square and polar wave equation models. Link to the report here: <a href = 'https://ddonle.com/docs/Chladni_Plate.pdf' target="_blank"> Chladni_Report </a> (or you can just view the pdf in the docs directory).
